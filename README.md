...
# Как использовать
## Загрузка модов
1. Скачать последний релиз SourceAPI Genomeia.
...
- Установить SourceAPI и jar-файл самой игры в качестве библиотек. В компилируемый jar-файл их добавлять не нужно.
### Шаг 2
